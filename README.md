...
where <img alt="$U_N^m = \exp(\frac{2\pi mi}{N})$" src="./svgs/d013ed342b6b91f061187f18f7a4a0e9.svg" align="middle" width="120.23340944999998pt" height="28.172905199999978pt"/> is m-th unity root of order N.

It has the following feature, which leads to Fast Fourier Transform (FFT) algorithm:

<img alt="$F(k) = F_e(k) + U_N^k F_o(k),$" src="./svgs/f415867e9461b7cd8ee8ea6e3223458d.svg" align="middle" width="184.21405694999999pt" height="27.91243950000002pt"/>
